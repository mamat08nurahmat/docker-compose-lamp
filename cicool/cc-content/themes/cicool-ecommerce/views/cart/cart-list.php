...
<div class="container ">
  <div class="col-md-12 table-responsive">
    ...
    <thead>
      <tr>
        <!-- <td width="1"><input type="checkbox" class="check-all" checked></td> -->
    ...
    <tbody>
      <?php foreach($carts as $item): 
        ...
        ?>
      <tr>
        <!-- <td><input type="checkbox" name="cartid[]" class="product-selected" value="<?= $item['rowid'] ?>" checked></td> -->
        <td width="20">
    ...
    <?php else: ?>
      <center style="margin-bottom: 50px;">
       <img style="height:150px; margin-top: 50px;" src="<?= theme_asset() ?>img/bag.svg" alt="">
...
<script>
  $(function(){
    ...
    $('.edit-notes-btn').click(function(event) {
