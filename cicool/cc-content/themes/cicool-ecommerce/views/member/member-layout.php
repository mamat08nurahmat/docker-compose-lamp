  ...
  <div class="col-md-2">
    <div>
      <ul class="member-menu">
        ...
        <li><a href="<?= base_url('member/account') ?>"  class="<?= $active == 'account' ? 'active' : ''  ?>"><div class="icon-member-menu-wrap"><span class="fal fa-user icon-member-menu"></span></div> My Account</a></li>
        <li><a href="<?= base_url('member/shipping') ?>"  class="<?= $active == 'shipping' ? 'active' : ''  ?>"><div class="icon-member-menu-wrap"><span class="fal fa-map-marker icon-member-menu"></span></div> Address</a></li>
        <li><a href="<?= base_url('member/order') ?>"  class="<?= $active == 'order' ? 'active' : ''  ?>"><div class="icon-member-menu-wrap"><span class="fal fa-shopping-cart icon-member-menu"></span></div> My Order</a></li>
      </ul>
    </div>
  </div>
  <div class="col-md-10">
