...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li class=""><a  href="<?= site_url('member/order'); ?>">Transaction</a></li>
                     ...
                     <?php foreach($transactions as $transaction): ?>
                        <tr>
                           ...
                           <td><?php if  ($transaction->status) {
                              ...
                              echo anchor('member/order_status/view/'.$transaction->status.'?popup=show', $transaction->transaction_status_status, ['class' => 'popup-view']); }?> </td>
